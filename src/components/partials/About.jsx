...
class About extends React.Component {
  ...
  render () {
    return (
      <>
        <div>
          <h5 className='mb-1'>Nex Browser</h5>
          ...
          <div>
            <h5 className='font-weight-light'>
              How can we improve Nex Browser?
            </h5>
            <br />
          ...
          <button
            ...
            onClick={() => {
              this.openUrl('https://discord.gg/zBfSCasSnX')
            }}
          >
            <i className='fa fa-heart mr-3'></i>Support to keep this project
            alive
          </button>
          <br />
          <br />
